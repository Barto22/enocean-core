...
/**
 * @file Led.hpp
 * @brief POSIX LED blinker abstraction for demonstration and testing.
 *
 * This file defines a simple LED blinker class (`LedBlinker`) for POSIX
 * platforms.
 *
 ...
 * @brief Namespace for POSIX LED abstractions.
 */
namespace Boards::Led {

/**
 * @class LedBlinker
 * @brief Simple LED blinker abstraction for POSIX platforms.
 *
